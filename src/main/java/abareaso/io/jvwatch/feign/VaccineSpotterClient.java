 ...
 *
 */
@ReactiveFeignClient(name = "vaccine-spotter-client", 
                     url = "${jvwatch.clinics.vaccine-spotter.service.url:}")
public interface VaccineSpotterClient 
{
	 ...
	 * @return A VaccineSpotterResp structure that contains 
	 * all of the clinics offering appointments for the given state.
	 */
